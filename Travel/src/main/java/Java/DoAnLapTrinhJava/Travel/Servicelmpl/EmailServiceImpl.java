...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendEmailWithImages(String recipient) throws MessagingException, IOException {
        ...
        String path = "D:/Images/travel-voucher.jpg";
        String message = "<html>\n" +
                "<head>\n" +
                "    <meta charset=\"UTF-8\">\n" +
                ...
                "            <p>\n" +
                "                <a class=\"button\" href=\"http://localhost:3000/home\">Trang chủ</a>\n" +
                "            </p>\n" +
                "        </div>\n" +
                "        <div class=\"footer\">\n" +
                ...
                "</body>\n" +
                "</html>";
        Path[] imagePaths = new Path[]{Path.of("D:/Images/travel-voucher.jpg"),Path.of("D:/Images/travel-voucher10.jpg")};
...
//            helper.addAttachment(null,path);
    ...
    public void sendSuccessPayment(String recipient, String transactionId) throws MessagingException, IOException {
        ...
        String message = "<h2> Your payment is success </h2> <p>This is you Transaction Id: " + transactionId+" give this to our staff</p>";
