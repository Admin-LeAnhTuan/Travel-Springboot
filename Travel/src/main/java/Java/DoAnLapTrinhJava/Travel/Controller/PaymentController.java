...
import Java.DoAnLapTrinhJava.Travel.Servicelmpl.EmailServiceImpl;
...
public class PaymentController {
    ...
    public ResponseEntity<User> createPayment(@RequestBody PaymentModel paymentModel) throws MessagingException, IOException {
        System.out.println(paymentModel.getGmail());
        ...
        emailService.sendSuccessPayment(paymentModel.getGmail(), paymentModel.getTransactionId());
    ...
    public ResponseEntity<List<Payment>> getAllPayment(){
        List<Payment> tourslst = paymentService.getAllPayment();
...
//        long amount = 10000000;
        ...
        vnp_Params.put("vnp_ReturnUrl", Config.vnp_Returnurl +"?tourId=" + payment.getTourId()+"&userId="
                + payment.getUserId() + "&quantity=" +payment.getQuantity() + "&gmail=" + payment.getGmail());
    ...
    public ResponseEntity<List<Payment>> getAllPayments(){
        List<Payment> paymentlst = paymentService.getAllPayment();
        return new ResponseEntity<>(paymentlst, HttpStatus.OK);
    }
}
